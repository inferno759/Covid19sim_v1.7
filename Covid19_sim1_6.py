...
def main():
    ...
    createSafePeople(personList, totalPeoplePop, safePeoplePop, 0, defaultActive, infectionChance, deathChance)
    createUnsafePeople(personList, totalPeoplePop, safePeoplePop, 0, defaultActive, infectionChance, deathChance)
...
def createSafePeople(personList, totalPeoplePop, safePeoplePop, riskFactor, defaultActive, infectChance, deathChance):
...
def createUnsafePeople(personList, totalPeoplePop, safePeoplePop, riskFactor, defaultActive, infectChance, deathChance):
